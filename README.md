...
There's not much documentation, because the original had no documentation. If I find a use for this beyond curiousity, I might add that as I go. Below is a dump of all the available functions, generated by godoc:
